/* **************************************************************************
FORMULA NAME: SC_GET_DEPARTMENT_NAME_FF
FORMULA TYPE: Extract Rule
DESCRIPTION : This Formula returns Postion Code and Position Name

Change History:
Name					Date 			Version 		Comments
-------------------------------------------------------------------------------
SK		01-Mar-2025 		1.0 			Initial Version
****************************************************************************** */
INPUTS ARE DATA_ELEMENTS (TEXT_TEXT)
RET=ESS_LOG_WRITE('SC_GET_DEPARTMENT_NAME_FF Fast Formula Started')
l_per_number = '0'
l_cost_id = 0
...
l_val = (GET_VALUE_SET('SC_GET_POSITION_ID_VS',
								'|=P_PERSON_NUMBER='''		||(l_per_number)||''''||
								'|P_EFFECTIVE_DATE='''||l_eff_dt||''''))

l_val = (GET_VALUE_SET('SC_GET_DEPARTMENT_NAME_VS',
								'|=P_ORG_ID='''		||(l_val)||''''))
rule_value = l_val
